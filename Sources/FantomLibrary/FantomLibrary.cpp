...
//#include <XRAD/PlatformSpecific/MSVC/PC_XRADBasicLink.h>
...
operation_result MARKT_DLL_EI GetSlice(frame_t &interpolated_image, 
									   slice_type st, 
...
operation_result MARKT_DLL_EI GetStudiesIDs(vector<Dicom::complete_study_id_t> &study_ids)
{
...
// Java implementation ==========================================================================
operation_result MARKT_DLL_EI InitFantom_J(const char *data_store_path)
{
	return tomogram.InitFantom_J(data_store_path);
}

operation_result MARKT_DLL_EI GetStudiesIDs_J(char **accession_numbers_in, int *length)
{
